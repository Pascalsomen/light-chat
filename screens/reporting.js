...
class ReportUserScreen extends Component {
  ...
  constructor(props) {
    ...
    verify = () =>{
       ...
       fetch('http://lightchat.panatechrwanda.tk/mobile/reportUsers.php ', {
         method: 'POST',
         headers: {
...
<Container style={styles.MainContainer}>
                ...
                <View style={styles.container}>
                  ...
                  <Text style={{fontSize:14,color:'#000'}}>Why are you reporting this user </Text> 
                  <TextInput placeholder="In Details"  ref={input => { this.textInputs = input }} onChangeText={code => this.setState({code})} style={styles.TextInputStyle}/>
