...
class ViewProfileScreen extends Component {
  ...
  View(image){
    if(image!=""){
      ...
      this.props.navigation.navigate('ProfileViewImageScreen',{image:image})
    }
    }
...
<Grid>
<Col onPress={this.View.bind(this, item.profile_pic_1)}>
...
<Col onPress={this.View.bind(this, item.profile_pic_2)}>
