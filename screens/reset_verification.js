...
class ResetVerifyScreen extends Component {
  ...
  constructor(props) {
    ...
    verify = () =>{
       ...
       fetch('http://lightchat.panatechrwanda.tk/mobile/reset_verify.php', {
         method: 'POST',
         headers: {
              ...
              if(responseJson === 1)
               {
                ...
                this.textInputs.clear()
                   ...
                   this.props.navigation.navigate('ResetPasswordScreen', {username: user });
