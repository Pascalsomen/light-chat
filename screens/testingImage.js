    ...
    class TestChatImageScreen extends Component {
...
<TextInput  placeholder="Add Caption (optional)" ref={input => { this.textInput = input }} onChangeText={message => this.setState({message})} style={{width:'75%'}}/> 
<Text  style={{alignSelf:'center',padding:10}}  onPress={this.Msg}><Icon name="ios-send" style={{color:'black',fontSize:25}}/></Text>     
    ...
    export default TestChatImageScreen
